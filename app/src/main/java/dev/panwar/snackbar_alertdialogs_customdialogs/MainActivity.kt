package dev.panwar.snackbar_alertdialogs_customdialogs
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
         ...
         */
//      for SNACK BAR.....no need to make any xml Dialog box
        val imageButton:ImageButton = findViewById(R.id.image_button)
        imageButton.setOnClickListener { view ->
            Snackbar.make(view, "You have clicked image button.", Snackbar.LENGTH_LONG).show()//same syntax as Toast....Toast and SnackBar has some difference see on stack Overflow
        }

        /**
         * Here we have handled onClick of Alert Dialog Button.
         */
//        for Alert Dialog //no need to make any xml Dialog box
    ...
    private fun alertDialogFunction() {
        ...
        alertDialog.setCancelable(false) // Will not allow user to cancel after clicking on remaining screen area(Area outside Alert Dialog Box)
        alertDialog.show()  // show the dialog to UI
    }

    /**
     * Method is used to show the Custom Dialog. we make this dialog in xml
     */
    ...
    The resource will be inflated, adding all top-level views to the screen.*/
        ...
        customDialog.findViewById<TextView>(R.id.tv_submit).setOnClickListener {
            Toast.makeText(applicationContext, "clicked submit", Toast.LENGTH_LONG).show()//we can use 'this' also instead of applicationContext....but applicationContext is better
    ...
    /**
     * Method is used to show the Custom Progress Dialog. or we can say show Buffering
     */
